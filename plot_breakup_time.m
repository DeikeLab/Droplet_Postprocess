function plot_breakup_time(T,col,mar,sz,fcol,filename,ls)

figure(2)
%     clf
%     T(1:end,4) = T(1:end,4)./T(1:end,1).^(1/3);
%       T(1:end,5) = T(1:end,5)./T(1:end,1).^(1/3);
    mu = T(1:7:end,1); we = T(1:7:end,2); tb = T(1:7:end,4); std = T(1:7:end,5);
    errorbar(we,tb,std,'Color',[1,0.1,0],'LineWidth',2,'LineStyle',ls); hold on;
